<x-catalogos-layout title="Nuevo subsector">
    ...
    <div class="mx-auto max-w-3xl space-y-5">
        ...
        <div class="rounded-lg border border-gray-200 bg-white">
            ...
            <div class="flex items-center gap-3 px-5 py-4">
                ...
                <div class="flex h-11 w-11 flex-shrink-0 items-center
                    ...
                    <i class="bi bi-list-nested text-xl text-gray-600"></i>
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-sm text-gray-500">
                        Registre el subsector y relaciónelo con su
                        macrosector y sector correspondiente.
                    </p>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-red-700">
                            No se pudo registrar el subsector.
                        </p>
        ...
        <div class="rounded-lg border border-gray-200 bg-white">
            ...
            <form
                method="POST"
                action="{{ route(
                    'clasificacion-inversion.subsectores.store'
                ) }}"
            >
                @csrf
                ...
                <div class="p-5">
                    ...
                    @include(
                        'clasificacion-inversion.subsectores.partials.form'
                    )
