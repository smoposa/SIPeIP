<x-objetivos-layout title="Detalle del Indicador">
    ...
    <!-- Barra de acciones -->
    @include('indicadores.partials.barra-menu')
    ...
    <div class="min-w-0 w-full overflow-x-hidden overflow-y-auto"
        ...
        <div class="min-w-0 bg-white p-6 shadow-sm">
            ...
            <!-- Cabecera -->
            @include('indicadores.partials.encabezado-detalle')


            <!-- Información general -->
            @include('indicadores.partials.informacion-general-detalle')

            <!-- resumen-planificacion --> 
            @include('indicadores.partials.resumen-planificacion')

            <!-- Estado y Auditoria -->
            @include('indicadores.partials.estado-auditoria')
