<x-objetivos-layout title="Editar PND">
    ...
    <div class="bg-white p-6 shadow-sm">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-semibold text-gray-800">
                Actualizar informacion del PND
            </h2>

            <p class="mt-1 text-sm text-gray-500">
                Modifique la información del Objetivo del Plan Nacional de Desarrollo.
            </p>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            ...
                            <select
                                ...
                                <option value="Social"
                                    {{ old('eje', $objetivo->eje) == 'Social' ? 'selected' : '' }}>
                                    Social
                                </option>

                                <option value="Desarrollo Económico"
                                    {{ old('eje', $objetivo->eje) == 'Desarrollo Económico' ? 'selected' : '' }}>
                                    Desarrollo Económico
                                </option>

                                <option value="Infraestructura, Energía y Medio Ambiente"
                                    {{ old('eje', $objetivo->eje) == 'Infraestructura, Energía y Medio Ambiente' ? 'selected' : '' }}>
                                    Infraestructura, Energía y Medio Ambiente
                                </option>

                                <option value="Institucional"
                                    {{ old('eje', $objetivo->eje) == 'Institucional' ? 'selected' : '' }}>
                                    Institucional
                                </option>

                                <option value="Gestión de Riesgos"
                                    {{ old('eje', $objetivo->eje) == 'Gestión de Riesgos' ? 'selected' : '' }}>
                                    Gestión de Riesgos
                                </option>
