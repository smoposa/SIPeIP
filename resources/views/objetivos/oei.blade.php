<x-objetivos-layout title="OEI">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('objetivos.createOEI') }}"
            ...
            <table class="min-w-full">
                ...
                <tbody>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td class="px-2 py-2 text-sm font-medium">
                                ...
                                <a href="{{ route('objetivos.detalle', $objetivo->id) }}"
                                   class="text-blue-600 hover:text-blue-800 hover:underline">
                                    ...
                                    {{ \Illuminate\Support\Str::limit($objetivo->nombre, 42) }}
                            ...
                            <!-- Entidad -->
                            <td class="px-2 py-2 text-sm text-gray-600">
                                {{ $objetivo->entidad?->siglas ?? 'No registra' }}
                            </td>

                            <!-- Plan -->
                            <td class="px-2 py-2 text-sm text-gray-600">
                                {{ \Illuminate\Support\Str::limit($objetivo->plan?->nombre ?? 'No registra', 25) }}
                            </td>
