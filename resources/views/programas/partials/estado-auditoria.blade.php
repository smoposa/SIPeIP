            ...
            <div class="flex min-w-0 flex-1 flex-wrap items-center gap-4">
                ...
                @if($programa->estado === 'Activo')
                    ...
                    <span class="inline-flex rounded-full bg-green-100
                                 px-3 py-1 text-xs font-medium text-green-700">
                        Activo
                    </span>
            ...
            <div class="min-w-0 flex-1">
                ...
                @switch($programa->estado_proceso)
                    ...
                    @case('En revisión')
                        ...
                        <span class="inline-flex rounded-full bg-yellow-100
                    ...
                    @case('Observado')
                        ...
                        <span class="inline-flex rounded-full bg-orange-100
    ...
    <div class="min-w-0 space-y-4">
        ...
        <div class="flex min-w-0 items-start gap-4">
            ...
            <span class="min-w-0 flex-1 break-words text-sm text-gray-600">
                {{ $programa->usuario?->name ?? 'No registra' }}
            </span>
